...
export const STRINGS = {
  ...
  unban:          { tr: 'Kaldır',                                     en: 'Unban' },
  suspendedTitle: { tr: 'Hesabın askıya alındı',                      en: 'Your account is suspended' },
  suspendedBlurb: { tr: 'Bu hesap topluluk kurallarını ihlal ettiği için oy verme ve yorum yapma kapatıldı.',
                    en: 'Voting and commenting are disabled on this account for breaking the community rules.' },
